...
class Login:
    ...
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file="C:/Users/SUMANA/OneDrive/Desktop/fake-product-detection-by-qr-using-blockchain/bg/OIP.jpg",master=root)
    ...
    def login(self):
        if self.txt_email.get()=="" or self.txt_password.get()=="":
            ...
            try:
                con=pymysql.connect(host="localhost",user="sumana",password="sumana",database="abhinaya")
                cur=con.cursor()
